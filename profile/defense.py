...
kv_file_path = os.path.join(os.path.dirname(__file__), 'defense.kv')
...
class DefenseScreen(Screen):
    ...
    def save_defense(self, play_defense):
        """
        Save the user's answer about playing defense to the profile and navigate to the next screen.
        """
        user_profile = load_user_profile()
        user_profile['defense'] = (play_defense == 'Yes')
        ...
        print(f"Do you play defense: {user_profile['defense']}")
        self.manager.current = 'goalie'  # Navigate to the GoalieScreen
